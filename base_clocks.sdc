...
## produces good results, but does it behave properly?
set_multicycle_path -from * -to {V1495_regs_communication:inst_regs|dcfifo:\blk_read_Fifo:dcfifo_component|dcfifo_gao1:auto_generated|altsyncram_0941:fifo_ram|ram_block15a0~porta_datain_reg*} -setup -end 2
set_multicycle_path -from * -to {V1495_regs_communication:inst_regs|dcfifo:\blk_read_Fifo:dcfifo_component|dcfifo_gao1:auto_generated|altsyncram_0941:fifo_ram|ram_block15a0~porta_datain_reg*} -hold -end 2
